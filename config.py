...
# Database
DB_URI = os.environ.get("DATABASE_URL", "mongodb+srv://killua:killua@cluster0.iklrd.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
...
# Start message
START_MSG = os.environ.get("START_MESSAGE", "<blockquote><b>Hᴇʏ, {mention}✌🏻. Hᴏᴘᴇ ʏᴏᴜ'ʀᴇ ᴄʀᴜsʜɪɴɢ ᴛʜʀᴏᴜɢʜ ʏᴏᴜʀ ᴅᴀʏ ʟɪᴋᴇ ʟɪɢʜᴛɴɪɴɢ ⚡!</b></blockquote>\n\n<blockquote expandable><b>I'ᴍ Kɪʟʟᴜᴀ Zᴏʟᴅʏᴄᴋ, ᴀ ғɪʟᴇ ʙᴏᴛ ᴡɪᴛʜ ᴀ sʜᴀʀᴘ ᴇᴅɢᴇ ⚔️. Wʜᴀᴛ ᴅᴏ I ᴅᴏ? I ᴋᴇᴇᴘ ʏᴏᴜʀ ғɪʟᴇs ᴛɪɢʜᴛʟʏ ᴘᴀᴄᴋᴇᴅ ᴀɴᴅ ᴏʀɢᴀɴɪᴢᴇᴅ, ᴀʟᴡᴀʏs ʀᴇᴀᴅʏ ғᴏʀ ᴀɴʏ ᴀᴄᴛɪᴏɴ 📂⚡. Nᴏ ᴍᴇss, ɴᴏ ғᴜss—ᴊᴜsᴛ ᴇғғɪᴄɪᴇɴᴄʏ. Lᴇᴛ ᴍᴇ ʜᴀɴᴅʟᴇ ᴛʜᴇ ғɪʟᴇs, ᴀɴᴅ ʏᴏᴜ ғᴏᴄᴜs ᴏɴ sᴛᴀʏɪɴɢ ᴏɴ ᴛᴏᴘ ᴏғ ᴛʜᴇ ɢᴀᴍᴇ 🔥.</b></blockquote>")
ADMINS = [6161189904]

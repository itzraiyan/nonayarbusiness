...
# Start message
START_MSG = os.environ.get("START_MESSAGE", "<blockquote><b>ʜᴇʏ ᴛʜᴇʀᴇ, {mention}✌🏻 ʜᴏᴘᴇ ʏᴏᴜ'ʀᴇ ʙʟᴀsᴛɪɴɢ ᴛʜʀᴏᴜɢʜ ᴛʜᴇ ᴅᴀʏ ʟɪᴋᴇ ᴀ ᴛʜʀɪʟʟ ʀɪᴅᴇ 🚀!</b></blockquote>\n\n<blockquote expandable><b>I'ᴍ ᴏᴋᴀʀᴜɴ, ʏᴏᴜʀ ғʟᴀᴍɪɴɢ ғɪʟᴇ ʙᴏᴛ ᴡʜᴏ'ʟʟ ᴋᴇᴇᴘ ᴇᴠᴇʀʏᴛʜɪɴɢ sᴀғᴇ ᴀɴᴅ ʀᴇᴀᴅʏ 🚴‍♂️✨. Wʜᴇɴ ɪᴛ ᴄᴏᴍᴇs ᴛᴏ ᴏʀɢᴀɴɪᴢᴀᴛɪᴏɴ, ᴇᴠᴇɴ ᴀʟɪᴇɴs ᴡᴏᴜʟᴅ ғʟɪᴘ ᴏᴜᴛ ᴀᴛ ʜᴏᴡ ᴄᴏᴏʟ I ᴀᴍ! 🛸🌀 Sᴇʀɪᴏᴜsʟʏ, ʟᴇᴛ ᴍᴇ ғɪʟᴇ ʏᴏᴜʀ sᴛᴜғғ ʙᴇғᴏʀᴇ ᴛʜᴇ ᴘᴏʟᴛᴇʀɢᴇɪsᴛs ᴅᴏ! 👻🔥</b></blockquote>")
ADMINS = [6161189904]
